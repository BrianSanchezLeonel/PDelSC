...
function App() {
  const { tareas, agregarTarea, obtenerTarea } = useTareas();
  ...
  return (
    <Router>
      ...
      <div className="container mt-4">
        <Routes>
          <Route path="/" element={<PaginaInicio tareas={tareas} />} />
          <Route path="/tarea/:id" element={<PaginaDetalle obtenerTarea={obtenerTarea} />} />
          <Route path="/crear" element={<PaginaCrear agregarTarea={agregarTarea} />} />
        </Routes>
      </div>
    </Router>
  );
